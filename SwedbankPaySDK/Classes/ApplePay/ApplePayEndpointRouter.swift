...
protocol ApplePayEndpointRouterProtocol {
    var body: [String: Any?]? { get }
}

struct ApplePayEndpointRouter: ApplePayEndpointRouterProtocol {
    ...
    // MARK: - Body
    var body: [String: Any?]? {
        var body: [String: Any?] = ["Instrument": "ApplePay",
...
extension ApplePayEndpointRouter {
